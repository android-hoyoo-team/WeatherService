...
.heading{background-image: url(../res/img/login/clipboard.png); width:442px; height:57px;margin:10px 7px 7px }
</style>
...
$(document).ready(function() {
	$("#login").click(function(){
		if($("#MEDIC_ID").val()!=null||$("#MEDIC_ID").val()!="")
		{
			$.ajax({
				"dataType" : 'json',
				"type" : "get",
...
<div class="login_panel"  >
	<p class="heading" style="height:50px"></p>
<!--     <ul class="login_ul"> -->
<!--     	<div class="container"> -->
			<form class="form-signin" style="padding:0px" role="form" id="loginForm" onsubmit="return false;" >
				<h4 class="form-signin-heading text-center">管理员登陆</h4>
			<div class="form-group form-group-lg">
				<input id="name" type="text" class="form-control" placeholder="用户" required autofocus>
			</div>
			<div class="form-group form-group-lg">
				<input id="password" type="password" class="form-control" placeholder="密码" required autofocus>
			</div>
...
<%--     <li><span>用户名:</span><input type="text" class="text" maxlength="30" id="MEDIC_ID" placeholder="身份证/医保卡/IC卡"  name="account" /></li> --%>
